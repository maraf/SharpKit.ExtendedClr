...
function Default(T){
    ...
    var type = Typeof(T);
    var jsType = type;
    if (jsType != null && jsType.get__JsType() != null && (jsType.get__JsType().Kind == "Struct" || (jsType.get__JsType().baseTypeName != null && jsType.get__JsType().baseTypeName.indexOf("ValueType") != -1))){
...
if (typeof(JsTypes) == "undefined")
    var JsTypes = [];
var SharpKit$ExtendedClr$Compilation$IJsImplType = {
    fullname: "SharpKit.ExtendedClr.Compilation.IJsImplType",
...
JsTypes.push(SharpKit$ExtendedClr$Compilation$IJsImplType);
...
var SharpKit$ArrayExtensions = {
    fullname: "SharpKit.ArrayExtensions",
    baseTypeName: "System.Object",
    staticDefinition: {
...
JsTypes.push(SharpKit$ArrayExtensions);
