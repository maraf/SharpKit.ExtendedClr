...
namespace SharpKit.ExtendedClr.Compilation
{
    ...
    {
        public static JsDelegateFunction RemoveDelegate(JsDelegateFunction delOriginal, JsDelegateFunction delToRemove)
        {
        ...
        public static JsDelegateFunction CombineDelegates(JsDelegateFunction del1, JsDelegateFunction del2)
        {
            if (del1 == null)
                return del2;
            if (del2 == null)
        ...
        [JsMethod(Code = "return new System.Type.ctor(jsType);")]
