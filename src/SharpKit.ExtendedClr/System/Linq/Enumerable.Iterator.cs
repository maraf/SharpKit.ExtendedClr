...
namespace System.Linq
{
    ...
    {
        [JsType(Name = "System.Linq.Enumerable.Iterator")]
        private abstract class Iterator<TSource> : IEnumerable<TSource>, IEnumerable, IEnumerator<TSource>, IDisposable, IEnumerator
        {
            ...
            public abstract JsImplEnumerable.Iterator<TSource> Clone();
            ...
            public IEnumerator<TSource> GetEnumerator()
            {
                ...
                JsImplEnumerable.Iterator<TSource> iterator = this.Clone();
                iterator.state = 1;
                return iterator;
            }
