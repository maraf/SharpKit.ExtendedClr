...
{
    [JsType(Name = "System.Linq.Enumerable")]
    internal static partial class JsImplEnumerable
    {
        ...
        public static TSource First<TSource>(this IEnumerable<TSource> source, Func<TSource, bool> predicate)
        {
            ...
            if (predicate == null)
            {
                throw JsImplError.ArgumentNull("predicate");
            }
        ...
        public static IEnumerable<TSource> Where<TSource>(this IEnumerable<TSource> source, Func<TSource, bool> predicate)
        {
            ...
            if (source is JsImplEnumerable.Iterator<TSource>)
            {
                return ((JsImplEnumerable.Iterator<TSource>)source).Where(predicate);
            }
            if (source is TSource[])
            {
                return new JsImplEnumerable.WhereArrayIterator<TSource>((TSource[])source, predicate);
            }
            if (source is List<TSource>)
            {
                return new JsImplEnumerable.WhereListIterator<TSource>((List<TSource>)source, predicate);
            }
            return new JsImplEnumerable.WhereEnumerableIterator<TSource>(source, predicate);
        }
        ...
        public static IEnumerable<TSource> Concat<TSource>(this IEnumerable<TSource> first, IEnumerable<TSource> second)
        {
            if (first == null)
            {
                throw JsImplError.ArgumentNull("first");
            }
            if (second == null)
            {
                throw JsImplError.ArgumentNull("second");
            }
        ...
        {
            return new JsImplOrderedEnumerable<TSource, TKey>(source, keySelector, null, false);
        }

        public static IOrderedEnumerable<TSource> OrderBy<TSource, TKey>(this IEnumerable<TSource> source, Func<TSource, TKey> keySelector, IComparer<TKey> comparer)
        {
            return new JsImplOrderedEnumerable<TSource, TKey>(source, keySelector, comparer, false);
        }

        public static IOrderedEnumerable<TSource> OrderByDescending<TSource, TKey>(this IEnumerable<TSource> source, Func<TSource, TKey> keySelector)
        {
            return new JsImplOrderedEnumerable<TSource, TKey>(source, keySelector, null, true);
        }

        public static IOrderedEnumerable<TSource> OrderByDescending<TSource, TKey>(this IEnumerable<TSource> source, Func<TSource, TKey> keySelector, IComparer<TKey> comparer)
        {
            return new JsImplOrderedEnumerable<TSource, TKey>(source, keySelector, comparer, true);
        }
        ...
        public static IEnumerable<TResult> Select<TSource, TResult>(this IEnumerable<TSource> source, Func<TSource, TResult> selector)
        {
            ...
            if (selector == null)
            {
                throw JsImplError.ArgumentNull("selector");
            }
            if (source is JsImplEnumerable.Iterator<TSource>)
            {
                return ((JsImplEnumerable.Iterator<TSource>)source).Select<TResult>(selector);
            }
            if (source is TSource[])
            {
                return new JsImplEnumerable.WhereSelectArrayIterator<TSource, TResult>((TSource[])source, null, selector);
            }
            if (source is List<TSource>)
            {
                return new JsImplEnumerable.WhereSelectListIterator<TSource, TResult>((List<TSource>)source, null, selector);
            }
            return new JsImplEnumerable.WhereSelectEnumerableIterator<TSource, TResult>(source, null, selector);
        }
        ...
        public static IEnumerable<TResult> SelectMany<TSource, TResult>(this IEnumerable<TSource> source, Func<TSource, IEnumerable<TResult>> selector)
        {
            ...
            if (source is TSource[])
            {
                return new JsImplEnumerable.SelectManyArrayIterator<TSource, TResult>((TSource[])source, selector);
            }
            if (source is List<TSource>)
            {
                return new JsImplEnumerable.SelectManyListIterator<TSource, TResult>((List<TSource>)source, selector);
            }
            return new JsImplEnumerable.SelectManyEnumerableIterator<TSource, TResult>(source, selector);
        }
        ...
        public static IEnumerable<TResult> SelectMany<TSource, TCollection, TResult>(this IEnumerable<TSource> source, Func<TSource, IEnumerable<TCollection>> collectionSelector, Func<TSource, TCollection, TResult> resultSelector)
        {
            ...
            {
                throw JsImplError.ArgumentNull("collectionSelector");
            }
            if (resultSelector == null)
            {
                throw JsImplError.ArgumentNull("resultSelector");
            }

            return Select(SelectMany(source, t => Select(collectionSelector(t), x => Tuple.Create(t, x))), pair => resultSelector(pair.Item1, pair.Item2));
        }
