...
namespace System
{
    [JsType(JsMode.Prototype, Name = "Number", OmitDefaultConstructor = true, OmitInheritance = true, NativeOverloads = false, NativeCasts = false, NativeOperatorOverloads = false)]
