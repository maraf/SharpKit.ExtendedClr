...
namespace System
{
	[JsType(Name = "System.Text.StringBuilder")]
	class JsImplStringBuilder
	{
		...
		public JsImplStringBuilder Append(char s)
		{
			this.array.push(s);
			this.length += 1;
            return this;
		...
		public JsImplStringBuilder Append(string s)
		{
			this.array.push(s);
		...
		public JsImplStringBuilder AppendFormat(string s, object arg0)
		{
		...
		public JsImplStringBuilder AppendFormat(string s, object arg0, object arg1)
		{
		...
		public JsImplStringBuilder AppendFormat(string s, object arg0, object arg1, object arg2)
		{
        ...
        public JsImplStringBuilder AppendLine()
        {
            return Append(Environment.NewLine);
        }

        public JsImplStringBuilder AppendLine(string s)
        {
            Append(s);
            return AppendLine();
        }

		public JsImplStringBuilder Append(object obj)
		{
			if (obj != null)
			{
				var s = obj.ToString();
    ...
    [JsType(Name = "System.StringComparison")]
